...
@section('content')
    ...
    <section class="container">
        ...
        <div class="row align-items-start">
            <div class="col">
                <a href={{ route('categories.index') }} class="btn btn-primary my-3 px-5 rounded-pill text-white"
                    style="padding: 20px">
                    <i class="fas fa-filter"></i> التصنيفات </a>
            </div>
            <div class="col">

                <a href={{ route('banner.index') }} class="btn btn-primary my-3 px-5 rounded-pill text-white"
                    style="padding: 20px">
                    <i class="fas fa-image"></i> البانر </a>
            </div>
            <div class="col">
                <a href={{ route('blogs.create') }} class="btn btn-primary my-3 px-5 rounded-pill text-white"
                    style="padding: 20px"><i class="fas fa-plus"></i> إضافة مدونة </a>
            </div>
            <div class="col">
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <a class="modal-effect btn btn-sm btn-danger open-delete-modal me-1"
                                        ...
                                        data-title="{{ $blog->title }}" data-url={{ route('blogs.destroy', $blog->id) }}
                                        data-toggle="modal" data-target="#deleteBlog" title="حذف">
