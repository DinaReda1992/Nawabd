...
@section('content')
    ...
    <section class="container">
        <div class="row"> <a href={{ route('categories.index') }} class="btn btn-primary my-3 px-5 rounded-pill text-white" style="padding: 20px">
                    <i class="fas fa-filter"></i>  التصنيفات </a>
            <div class="col-12" style="display: flex; justify-content: space-between">
                <a href={{ route('blogs.create') }} class="btn btn-primary my-3 px-5 rounded-pill text-white" style="padding: 20px"><i
                        ...
                        <tbody>
                            @foreach ($blogs as $blog)
                                <tr>
                                    ...
                                    <td>{!! substr($blog->content,0,400) !!}...
                                    </td>
                                    <td>
                                        <a href={{ route('blogs.showBlog', $blog->id) }} title="إظهار المحتوى">
                                            <img src="{{ asset('images/' . $blog->logo) }}" width="100"></a>
                                    </td>
                                    <td>{{ $blog->author }}</td>
                                    <td class="d-flex">
                        ...
                        <form id="deleteForm" class="modal-dialog" action="" method="post">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <h5 class="h4 modal-title text-center text-primary" id="exampleModalLabel">حذف المقال
                                    </h5>
